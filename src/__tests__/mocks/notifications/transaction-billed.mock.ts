...
export const TransactionBilledMock: IEventsResponse<ITransactionNotificationResponse> = {
  ...
  notification_id: 'ntf_01h8e3a52eayz16zsgzjzxmkcz',
  data: {
...
export const TransactionBilledMockExpectation = {
  data: {
    ...
    status: 'billed',
    subscriptionId: null,
    updatedAt: '2023-08-22T07:45:54.81387658Z',
  },
  eventId: 'evt_01h8e3a5029s6xrd5qj89beawp',
  eventType: 'transaction.billed',
  notificationId: 'ntf_01h8e3a52eayz16zsgzjzxmkcz',
  occurredAt: '2023-08-22T07:45:55.202630Z',
};
