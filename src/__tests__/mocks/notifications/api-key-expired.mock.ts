...
export const ApiKeyExpiredMock: IEventsResponse<IApiKeyNotificationResponse> = {
...
export const ApiKeyExpiredMockExpectation = {
  eventId: 'evt_01jkdr0rc527wcjdg1txsdxhth',
  eventType: 'api_key.expired',
  occurredAt: '2025-03-26T06:58:38.517522Z',
  notificationId: 'ntf_01jkdr1mgbe62eqkh3p0fq8b0k',
  data: {
    id: 'apikey_01jkdpbhazdpn3wpcya45as9tg',
    name: 'CRM integration',
    description: 'Used to authenticate with the API for storing Paddle customer data in our CRM.',
